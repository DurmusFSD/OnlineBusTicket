        ...
        <div className="col-span-1 space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-bold text-neutral-900 dark:text-neutral-50">
              Luxury Bus
              <span className="text-base font-bold text-neutral-400 dark:text-neutral-500 ml-3">
                (Bus Number Plate)
              </span>
            </h1>
            ...
            <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal">
              ...
              similique aspernatur architecto unde eum omnis iusto odit qui
              odio. Facere a placeat maxime cupiditate accusantium? Lorem ipsum
              dolor sit amet consectetur adipisicing elit. Ea similique
              aspernatur architecto unde eum omnis iusto odit qui odio. Facere a
              placeat maxime cupiditate accusantium?
            </p>
          </div>
        </div>
